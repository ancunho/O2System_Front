...
import { getProjectView, projectBaseInfoUpdate, projectDetailUpdate } from '@/api/project'
      ...
      this.$nextTick(() => {
        ...
        new Promise(resolve => {
          ...
          return getProjectView({
            ...
            if (!(['ROLE_ADMIN'].includes(userInfo.role) ||
              this.permissionList.includes(userInfo.id))) {
